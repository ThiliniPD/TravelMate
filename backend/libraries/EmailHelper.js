...
class EmailHelper {
    ...
    static sendEmail(recipient, subject, textContent = null, htmlContent = null, template = null) {
        ...
        const msg = {
            to: recipient, 
            from: process.env.SENDGRID_FROM || 'user@example.com', // Change to your verified sender
            subject: subject,
        }
    ...
    static sendPasswordReset(recipient) {
        ...
        return EmailHelper.sendEmail(recipient, 'Your password has been reset', null, null, 'd-c3c8301936114c3fb825ad3dc290472b') // change to a pre-existing template id
    }
}
